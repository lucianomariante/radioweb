...
// public function tp_elementor_install() {
...
// 	if ( is_plugin_active( $elementor_slug ) ) {
// 		return;
// 	}

// 	if ( isset( $all_plugins[ $elementor_slug ] ) ) {
// 		return;
// 	}
...
// 		activate_plugin( $elementor_slug );
...
// }
	...
	public function tp_f_plugin_loaded() {
		...
		if ( ! did_action( 'elementor/loaded' ) ) {
			...
			// add_action( 'admin_init', array( $this, 'tp_elementor_install' ) );
			return;
		}
